...
const PROJETS: Omit<ProjetCardProps, 'index'>[] = [
  ...
  {
    nom: 'Z Entreprises',
    fiches: ['FICHE 01', 'FICHE 04'],
    description: 'Application mobile et assistant conversationnel intégré. Chatbot sur-mesure connecté aux données métier via Claude API et RAG.',
    resultat: '—',
    statut: 'en cours',
  },
]
